...
export default function Dropdown({
    ...
    return (
        ...
        >
            <a 
                href="#0"
                className='text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex itemscenter transition duration-150 ease-in-out'
            ...
            <Transition
                ...
                enter='transistion ease-out duration-200 transform'
                enterFrom='opacity-0 -translate-y-2'
                enterTo='opacity-100 translate-y-0'
                leave='translate ease-out duration-200'
